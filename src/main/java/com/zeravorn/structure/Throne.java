...
public final class Throne {
    private final String id; private final TeamId team; private int health=7000;
    public Throne(String id, TeamId team){this.id=Objects.requireNonNull(id);this.team=Objects.requireNonNull(team);}
    public String id(){return id;} public TeamId team(){return team;} public int health(){return health;} public int maxHealth(){return 7000;} public boolean destroyed(){return health==0;}
